...
function TechnicalConcessionInquiry(){
var srlink = "https://10.20.101.222:12900/csp/sr/business.action?BMEBusiness=srNewSrPage&srTypeName=Technical%20Concession&srTypeId=100034002";
var CSTNumber = "&subsNumber=" + document.getElementById("CSTNumber").value;
var Title = "&serviceTitle=FBB Non Tech Inquiry->Billing Adjustment->Technical Concession";
var Problem = "&serviceInfoChar282=Technical Concession Inquiry";
var secondaryMobile = "&serviceInfoChar272=0";
var cpeTypeselect = "&serviceInfoChar278=1";
var pre = "&serviceInfoChar276=2";
var FollowUP = document.getElementById("followup");
if (FollowUP.checked == true)
{ FollowUP = "&serviceContent=Technical Concession Inquiry"; } else { FollowUP = ""; }
window.open(srlink + CSTNumber + Title + Problem + FollowUP + secondaryMobile + cpeTypeselect + pre);
}
function TechnicalConcessionComplaint(){
var srlink = "https://10.20.101.222:12900/csp/sr/business.action?BMEBusiness=srNewSrPage&srTypeName=Technical%20Concession&srTypeId=099019002";
var CSTNumber = "&subsNumber=" + document.getElementById("CSTNumber").value;
var Title = "&serviceTitle=FBB Non Technical Complaint->Billing Adjustment->Technical Concession";
...
var FollowUP = document.getElementById("followup");
if (FollowUP.checked == true)
{ FollowUP = "&serviceContent=Technical Concession Complaint"; } else { FollowUP = ""; }
window.open(srlink + CSTNumber + Title + Problem + FollowUP + secondaryMobile + cpeTypeselect + pre);
}
function QAComplaints(){
var srlink = "https://10.20.101.222:12900/csp/sr/business.action?BMEBusiness=srNewSrPage&srTypeName=QA%20Complaints&srTypeId=099010002";
var CSTNumber = "&subsNumber=" + document.getElementById("CSTNumber").value;
var Title = "&serviceTitle=FBB Non Technical Complaint->Internet Service->QA Complaints";
var Problem = "&serviceInfoChar282=QA Complaints";
var secondaryMobile = "&serviceInfoChar272=0";
var cpeTypeselect = "&serviceInfoChar278=1";
var pre = "&serviceInfoChar276=2";
var FollowUP = document.getElementById("followup");
if (FollowUP.checked == true)
{ FollowUP = "&serviceContent=QA Complaints"; } else { FollowUP = ""; }
window.open(srlink + CSTNumber + Title + Problem + FollowUP + secondaryMobile + cpeTypeselect + pre);
}
