...
darkmode.addEventListener("click",()=>{
    ...
    darkpanal.classList.replace("hide" , "show")
})
...
let CSTNumber = document.getElementById("CSTNumber")
$(".clearusednum li").click(function clearusednum() {
    setTimeout( function () {CSTNumber.value=""} , 20000 )
})
...
function showIntroduction(){
    $(".introductiondiv").slideDown(3000)
    introductionbtn.innerHTML = "CLOSE"
    introduction.style.right = "5.5%"
    introductionbtn.onclick = closeIntroduction
}
function closeIntroduction() {
    $(".introductiondiv").slideUp(2000)
    introductionbtn.innerHTML = "Docs"
    introduction.style.right = "4.5%"
    introductionbtn.onclick = showIntroduction
}
